...
void BasicGraphicsPipeline::SetFlareDiffuseMap(Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> texture)
{
	mFlareDiffuseMap = texture;
}

void BasicGraphicsPipeline::SetFlareAlphaMap(Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> texture)
{
	mFlareAlphaMap = texture;
}
...
{
	return mObjectCB.data.useTexture;
}

void BasicGraphicsPipeline::SetSamplerState(Microsoft::WRL::ComPtr<ID3D11SamplerState> sampler)
{
...
void BasicGraphicsPipeline::Bind(ID3D11DeviceContext* context) const
{
	...
	ID3D11ShaderResourceView* srvs[] = { mDiffuseMap.Get(), mFlareDiffuseMap.Get(), mFlareAlphaMap.Get() };
