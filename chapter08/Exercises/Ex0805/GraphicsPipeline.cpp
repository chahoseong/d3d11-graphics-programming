...
void BasicGraphicsPipeline::SetFireDiffuseMap(Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> texture)
{
	mFireDiffuseMap = texture;
}
...
void BasicGraphicsPipeline::Bind(ID3D11DeviceContext* context) const
{
	...
	ID3D11ShaderResourceView* srvs[] = { mDiffuseMap.Get(), mFireDiffuseMap.Get() };
