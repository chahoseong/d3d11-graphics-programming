...
void LightingApp::DrawImGui()
{
	...
	float directionalDiffuse[3] = {
		mDirLight.Diffuse.x,
		mDirLight.Diffuse.y,
		mDirLight.Diffuse.z
	};
	float pointDiffuse[3] = {
		mPointLight.Diffuse.x,
		mPointLight.Diffuse.y,
		mPointLight.Diffuse.z
	};
	float spotDiffuse[3] = {
		mSpotLight.Diffuse.x,
		mSpotLight.Diffuse.y,
		mSpotLight.Diffuse.z
	};
	...
	if (ImGui::ColorEdit3("Directional Diffuse", directionalDiffuse)) {
		mDirLight.Diffuse.x = directionalDiffuse[0];
		mDirLight.Diffuse.y = directionalDiffuse[1];
		mDirLight.Diffuse.z = directionalDiffuse[2];
	}

	if (ImGui::ColorEdit3("Point Diffuse", pointDiffuse)) {
		mPointLight.Diffuse.x = pointDiffuse[0];
		mPointLight.Diffuse.y = pointDiffuse[1];
		mPointLight.Diffuse.z = pointDiffuse[2];
	}

	if (ImGui::ColorEdit3("Spot Diffuse", spotDiffuse)) {
		mSpotLight.Diffuse.x = spotDiffuse[0];
		mSpotLight.Diffuse.y = spotDiffuse[1];
		mSpotLight.Diffuse.z = spotDiffuse[2];
	}
