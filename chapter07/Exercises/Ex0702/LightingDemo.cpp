...
void LightingApp::DrawImGui()
{
	...
	float directionalSpecPower = mDirLight.Specular.w;
	float pointSpecPower = mPointLight.Specular.w;
	float spotSpecPower = mSpotLight.Specular.w;
	...
	if (ImGui::InputFloat("Directional Specular Power", &directionalSpecPower, 1.0f)) {
		mDirLight.Specular.w = directionalSpecPower;
	}

	if (ImGui::InputFloat("Point Specular Power", &pointSpecPower, 1.0f)) {
		mPointLight.Specular.w = pointSpecPower;
	}

	if (ImGui::InputFloat("Spot Specular Power", &spotSpecPower, 1.0f)) {
		mSpotLight.Specular.w = spotSpecPower;
	}
