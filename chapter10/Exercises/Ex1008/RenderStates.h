...
public:
	...
	static Microsoft::WRL::ComPtr<ID3D11BlendState> NoRenderTargetWriteBS;

	static Microsoft::WRL::ComPtr<ID3D11DepthStencilState> OverdrawCalcDSS;
	static Microsoft::WRL::ComPtr<ID3D11DepthStencilState> OverdrawVisualDSS;
