...
class ColorGraphicsPipeline : public GraphicsPipeline
{
	struct FrameBuffer
	{
...
public:
	ColorGraphicsPipeline(ID3D11Device* device);

	void SetColor(const DirectX::FXMVECTOR color);
	void SetProjection(DirectX::CXMMATRIX M);
...
private:
	...
	ConstantBuffer<FrameBuffer> mFrameCB;
};
...
public:
	...
	static ColorGraphicsPipeline* Color;
};
